  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-4">API 请求示例</h1>
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-gray-600 mb-2">
              在 <code className="bg-gray-100 px-1 rounded">src/services/</code>{' '}
              目录下定义 API 服务
            </p>
...
const { data, loading, error } = useApiWithParams(
  ...
  [page, limit, search]
          ...
          <div>
            ...
            <p className="text-gray-600 mb-2">统一的错误处理和用户反馈</p>
            <pre className="bg-gray-100 p-3 rounded text-sm overflow-x-auto">
              {`// 错误处理
if (error) {
